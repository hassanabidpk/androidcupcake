package com.hassanabid.androidcupcake.activities;
...
public class CupcakeDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cupcake_detail);
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(CupcakeDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(CupcakeDetailFragment.ARG_ITEM_ID));
