...
public class CupcakeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.cupcake_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(CupcakeDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(CupcakeDetailFragment.ARG_ITEM_ID, holder.mItem.id);
